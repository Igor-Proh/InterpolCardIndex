...
CREATE TABLE IF NOT EXISTS criminal_group (
...
VALUES
    ...
    (7, 'James', 'Taylor', 'Joker', 180.0, 'Green', 'Brown', 'Smile tattoo on hand', 'American', '1987-02-08', '345 Pine Ave, City', 'English, French', 'Prankster', 'Public disturbance',1, 0, null),
    ...
    (10, 'Olivia', 'Jackson', 'Siren', 170.2, 'Red', 'Green', 'Birthmark on neck', 'American', '1989-04-05', '111 Maple Dr, Town', 'English, Spanish', 'Smuggler', 'Contraband trafficking',1, 0, null),
